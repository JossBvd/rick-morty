  ...
  return (
    <>
      ...
      <main className=' bg-gray-300 p-5'>
        ...
        {searchTerm ? (
          <button onClick={resetSearch} className="text-white bg-red-700 hover:red-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
            Reset Filter
          </button>
        ) : undefined}
